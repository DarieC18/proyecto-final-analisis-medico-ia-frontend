    ...
    <div class="card shadow-sm">
      <div class="card-body p-5">
        ...
        <div v-if="tabActual === 'info'" class="animation-fade">
          ...
          <textarea class="form-control bg-light border-0 p-4 rounded-4 mb-4" rows="4" placeholder="Redacte el historial o evolución médica aquí..."></textarea> 
          <div class="d-flex justify-content-end">
            <button class="btn btn-primary px-4 py-2">Guardar Registro</button>
          </div>
        </div>
        ...
        <div v-if="tabActual === 'sintomas'" class="animation-fade">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-primary btn-sm px-3 shadow-sm">+ Agregar Síntoma</button>
          </div>
          
          <div class="row g-4">
            <div class="col-md-6">
              <div class="card bg-light border-0 border-start border-4 border-danger shadow-sm h-100 p-3 rounded-4">
                <div class="d-flex justify-content-between align-items-start mb-2">
                  <h6 class="fw-bold mb-0">Fiebre y Escalofríos</h6>
                  <span class="badge bg-danger rounded-pill px-3">Severo</span>
                </div>
                <p class="text-muted small mb-2"><strong>Inicio:</strong> 14 Jun 2026</p>
                <p class="mb-0 text-dark small">El paciente reporta picos de fiebre de hasta 39.5°C principalmente por las noches, acompañados de sudoración.</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card bg-light border-0 border-start border-4 border-warning shadow-sm h-100 p-3 rounded-4">
                <div class="d-flex justify-content-between align-items-start mb-2">
                  <h6 class="fw-bold mb-0">Mareos y Fatiga</h6>
                  <span class="badge bg-warning text-dark rounded-pill px-3">Moderado</span>
                </div>
                <p class="text-muted small mb-2"><strong>Inicio:</strong> 15 Jun 2026</p>
                <p class="mb-0 text-dark small">Sensación de vértigo al levantarse bruscamente de la cama. Debilidad generalizada.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="tabActual === 'ia'" class="animation-fade">
          ...
          <div v-else class="bg-light p-4 rounded-4 border-start border-5 border-info position-relative">
            ...
            <h5 class="fw-bold text-info mb-3"><i class="bi bi-robot"></i> Resultado del Análisis Clínico</h5>
            <div class="mb-3">
            ...
            <div class="alert alert-warning mb-0 border-0 rounded-3 shadow-sm text-center">
              <small class="fw-bold">⚠️ AVISO LEGAL:</small> <small>Este análisis es generado por IA para asistir la decisión médica y no sustituye el diagnóstico oficial de un profesional de la salud.</small>
            </div>
          </div>
        </div>
